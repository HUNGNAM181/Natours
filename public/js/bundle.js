...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    var popup = L.popup({
      autoClose: false,
      // không tự đóng khi mở popup khác
      closeOnClick: false // không đóng khi click ra ngoài
    }).setLatLng([lat, lng]) // đặt vị trí popup
    .setContent("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")) // nội dung popup
      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign('/'); // hoặc chuyển tới '/me' nếu bạn muốn
            }, 1500);
          }
          _context.n = 3;
          break;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.p = 1;
          _context.n = 2;
          return fetch('/api/v1/payment/create-payment', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            },
        ...
        case 3:
          ...
          if (data.status === 'success') {
            ...
            (0, _alerts.showAlert)('success', 'Đang chuyển sang cổng thanh toán...');
            setTimeout(function () {
              window.location.href = data.paymentUrl;
            }, 800);
          } else {
            (0, _alerts.showAlert)('error', 'Không thể tạo giao dịch VNPay');
          }
          _context.n = 5;
          break;
        case 4:
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */ // ✅ thêm dòng này để nút "Book tour now" hoạt động
// ✅ thêm để hiển thị alert thanh toán
...
(function handlePaymentAlertFromQuery() {
  try {
    ...
    if (payment === 'success') {
      (0, _alerts.showAlert)('success', "Thanh to\xE1n th\xE0nh c\xF4ng! \uD83C\uDF89 M\xE3 \u0111\u01A1n h\xE0ng: ".concat(orderId || ''));
      // Xóa query để không hiện lại alert khi F5
      window.history.replaceState({}, document.title, window.location.pathname);
    } else if (payment === 'fail') {
      (0, _alerts.showAlert)('error', "Thanh to\xE1n th\u1EA5t b\u1EA1i! \u274C ".concat(orderId ? "M\xE3 \u0111\u01A1n h\xE0ng: ".concat(orderId) : ''));
      window.history.replaceState({}, document.title, window.location.pathname);
    }
  } catch (err) {
